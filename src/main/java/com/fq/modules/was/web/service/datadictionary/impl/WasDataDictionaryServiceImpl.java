...
import com.fq.modules.was.web.mapper.datadictionary.WasDataDictionaryMapper;
...
public class WasDataDictionaryServiceImpl extends BaseServiceImpl implements WasDataDictionaryService {
    ...
    public boolean insert(WasDataDictionary wasDataDictionary) {
        ...
        //系统操作日志
        sysLogMapper.addSysLog(new SysLog(1,getUserName(),getUserName()+"在"+DatesUtils.time()+"新增数字货币"+wasDataDictionary.getWasType()+"的信息",result));
    ...
    public boolean updateById(WasDataDictionary wasDataDictionary) {
        ...
        //系统操作日志
        sysLogMapper.addSysLog(new SysLog(2,getUserName(),getUserName()+"在"+DatesUtils.time()+"修改数字货币"+wasDataDictionary.getWasType()+"的信息",result));
