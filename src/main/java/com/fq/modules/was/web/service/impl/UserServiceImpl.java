...
import com.fq.modules.was.web.mapper.UserMapper;
...
import com.fq.modules.was.web.mapper.RoleMapper;
import com.fq.modules.was.web.mapper.UserMapper;
import com.fq.modules.was.web.service.UserService;
...
public class UserServiceImpl extends BaseServiceImpl implements UserService {
    ...
    public List<User> findAllUser(String userName) {
        ...
        String result = "查询成功";
        wasSysLogMapper.insert(new WasSysLog(3,getUserName(),content,result));
    ...
    public boolean updateUser(User bean) {
        ...
        if (CommonUtil.isNotEmpty(user)) {
            ...
            //记录系统日志
            String result = "修改成功";
            wasSysLogMapper.insert(new WasSysLog(2,getUserName(),content,result));
        }
    ...
    public boolean checkPassword(String userName, String password) {
        ...
        if (CommonUtil.isNotEmpty(user)) {
            ...
            if (str.equals(MD5Util.getMD5(userName+MD5Util.getMD5(password)))) {
                ...
                wasSysLogMapper.insert(wasSysLog);
    ...
    public int deleteUser(User user) {
        ...
        WasSysLog wasSysLog = new WasSysLog(4,user.getUserName(),content,result);
        wasSysLogMapper.insert(wasSysLog);
    ...
    public int addUser(User user) {
        ...
        WasSysLog wasSysLog = new WasSysLog(1,user.getUserName(),content,result);
        wasSysLogMapper.insert(wasSysLog);
