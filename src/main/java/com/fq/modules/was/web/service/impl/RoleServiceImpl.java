...
import com.fq.modules.was.web.service.RoleService;
...
public class RoleServiceImpl extends BaseServiceImpl implements RoleService {
    ...
    public boolean addRole(Role role, String menus) {
        ...
        //记录系统日志
        String result = "新增成功";
        wasSysLogMapper.insert(new WasSysLog(1,getUserName(),content,result));
    ...
    public boolean deleteRole(Long gid) {
        ...
        wasSysLogMapper.insert(new WasSysLog(1,getUserName(),getUserName()+"在"+DatesUtils.time()+"修改角色信息,id="+gid,result));
