...
@Service
public class PayOperatorHistoryServiceImpl extends BaseServiceImpl implements PayOperatorHistoryService {
    ...
    */
     ...
     * @return
     */
    public boolean insert(PayOperatorHistory payOperatorHistory) {
     ...
     * @return
     */
    public boolean updateById(PayOperatorHistory payOperatorHistory) {
