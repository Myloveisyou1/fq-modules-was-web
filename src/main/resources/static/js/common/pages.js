...
var totalPage = 0, pp = "", c = '"b"', d = 'this.value=this.value.replace(/[^0-9]/g,"")',
    to = "onkeyup='" + d + ",document.getElementById(" + c + ").value=this.value' onblur='document.getElementById(" + c + ").value=this.value'";
